...
public class LanguageManager: NSObject, ObservableObject {
  ...
  private let en: [String: String] = [
    ...
    "Streaming Style": "Picture, Latency & Input",
    "Streaming Style detail": "A preset that balances picture stability, latency, and control feel.",
    "Timing": "Timing",
    "Compatibility & Troubleshooting": "Compatibility & Troubleshooting",
    "HDR": "HDR",
    "Frame Pacing": "Frame Pacing",
    "Lowest Latency": "Input Priority",
    "Smoothest Video": "Video Priority",
    ...
    "CoreHID Mouse requires macOS 15 or later.": "CoreHID mouse requires macOS 15 or later.",
    "CoreHID Mouse access denied. Allow Input Monitoring in System Settings.":
      "CoreHID mouse access denied. Allow Input Monitoring in System Settings.",
    "CoreHID Mouse input failed.": "CoreHID mouse input failed.",
  ...
  private let zhHans: [String: String] = [
    ...
    "Video": "视频",
    "Video Codec": "视频编解码器",
    "Streaming Style": "画面延迟与操作",
    "Streaming Style detail": "用预设快速调整：更跟手，还是更稳画面。",
    "Timing": "时序",
    ...
    "Trackpad": "触控板",
    "Touchscreen": "触摸屏",
    "CoreHID Mouse requires macOS 15 or later.": "CoreHID 鼠标需要 macOS 15 或更高版本。",
    "CoreHID Mouse access denied. Allow Input Monitoring in System Settings.":
      "CoreHID 鼠标访问被拒绝。请在系统设置中允许“输入监控”。",
    "CoreHID Mouse input failed.": "CoreHID 鼠标输入失败。",
